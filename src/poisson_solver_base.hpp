...
using Poisson_sp_solver =
	es_la::Pardiso_solver<es_la::Csr_matrix<double, es_la::Symmetric_upper>>;

class Poisson_solver_base :
	public es_fe::Matrix_based_nonlinear_solver<Poisson_system, Poisson_sp_solver>
{
private:
...
protected:
	...
	{
		solution_.zero(); // Local charge neutrality
	}
